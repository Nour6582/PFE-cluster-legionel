# Generated by Django 4.0.4 on 2022-06-04 23:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='introducteurDinfo',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Nom', models.CharField(max_length=30)),
                ('Prenom', models.CharField(max_length=30)),
                ('Email', models.EmailField(blank=True, max_length=254)),
                ('telPortable', models.IntegerField(verbose_name='Tel portable')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introducteurDinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='identifiant.introducteurdinfo')),
