...
from .views import  DetailPatient,DeletePatient, InfoCliniqueform, ListPatient, QuestionAvecPrelevementform, UpdatePatient,InfoRadiologiqueform,QuestionAvecPrelevementform,InfoBiologiqueform, UpdateInfoClinique,UpdateInfoRadiologique,UpdateInfoBiologique,UpdateQuestionAvecPrelevement,casMaladeform,search
...
urlpatterns = [
   ...
   path('<int:pk>/DeletePatient/',DeletePatient.as_view(),name="DeletePatient"),
